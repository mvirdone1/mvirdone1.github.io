...
/*const globalMapInformation = [
    {
        name: "Green Canyon - single track",
    ...
    {
        name: "Green Canyon - ski trail",
        jsonFile: greenSkiTrack,
        lineParams: { style: "dotted" },
        reports: [],
...
function initMap() {
    ...
    */
    ...
    /*
    console.log("trail object:", myTrail);

    myTrail.addListener("click", function (event) {
        console.log("Polyline clicked at:", event.latLng.toString());

        // Example: open an info window at the click point
...
function processReceivedTrailConditions() {
    alert("Hello!");
}
